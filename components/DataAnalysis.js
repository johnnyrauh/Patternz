    ...
    return (
      <View>
        ...
        <View style={{alignItems: 'center', paddingTop: 20}}>
          <Text style={{ fontSize: 17}}>Total Current Tasks: {this.props.screenProps.items.length}</Text>
          <Text style={{ fontSize: 17}}>Total Tasks Completed: {this.props.screenProps.completedItems.length}</Text>
        </View>
          <View style={{alignItems: 'center', padding: 50}}>
        <ProgressCircle style={styles.circle}
          percent={(this.props.screenProps.completedItems.length /
